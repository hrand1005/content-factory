...
do
    ...
    ffmpeg -i $file -vf "drawtext=fontfile=/usr/share/fonts/truetype/dejavu/DejaVuSerif-Bold.ttf:text='TEXT':fontcolor=white:fontsize=24:box=1:boxcolor=black@0.5:boxborderw=5:x=0:y=0" c:v libx264 -preset slow -crf 22 -c:a copy $basename.mkv
